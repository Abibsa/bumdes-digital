...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[420px] glass rounded-[2rem] shadow-2xl overflow-hidden relative z-10 border border-white/60">
        <div className="p-10 text-center relative overflow-hidden bg-white/40">
          ...
          <h1 className="text-3xl font-extrabold text-primary-950 mb-2 tracking-tight">BUMDes Digital</h1>
          <p className="text-slate-600 font-medium text-sm">Masuk untuk mengelola operasional desa</p>
        </div>
        
        <div className="p-8 pt-4 bg-white/80">
          {error && (
            <div className="mb-6 p-4 bg-rose-50 text-rose-700 rounded-xl text-sm border border-rose-200 font-medium flex items-center gap-2">
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3.5 bg-slate-50/50 border-2 border-slate-200 rounded-xl focus:outline-none focus:ring-0 focus:border-primary-500 trans-all text-sm font-medium text-slate-800"
          ...
          <div className="mt-8 text-center">
            <p className="text-xs font-semibold text-slate-400">VERSI 2.0 &bull; DILINDUNGI SISTEM KEAMANAN</p>
          </div>
        </div>
      </div>
    </div>
